...
$sqlUnggah = "SELECT Id_struktur, nama FROM struktur";
$resultUnggah = $conn->query($sqlUnggah);
?>                     
...
$sql = "SELECT produk.*, struktur.nama AS p_unggah 
        FROM produk
        LEFT JOIN struktur ON produk.p_unggah = struktur.Id_struktur";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
                    echo "<td>" . $no++ . "</td>";
                    echo "<td>" . htmlspecialchars($row['p_unggah']) . "</td>";
                    ...
                    data-id='" . $row['id'] . "' 
                    data-kegiatan='" . htmlspecialchars($row['p_unggah']) . "' 
            ...
            echo "<tr>";
echo "<td colspan='5' class='text-center'><strong>Tambah Data Baru</strong></td>";
echo "<td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="addModalLabel"><i class="fas fa-plus-circle"></i> Tambah Data Produk Peraturan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="tambah_produk.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        <select class="form-control form-control-lg" id="p_unggah" name="p_unggah" required>
                            <option value="">Pilih Pengunggah</option>
                            <?php
                            if ($resultUnggah->num_rows > 0) {
                                while ($row = $resultUnggah->fetch_assoc()) {
                                    $unggahId = htmlspecialchars($row['Id_struktur']);
                                    $unggahNama = htmlspecialchars($row['nama']);
                                    echo "<option value='$unggahId'>$unggahNama</option>";
                                }
                            } else {
                                echo "<option value=''>Tidak ada pengunggah</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control form-control-lg" id="isi" name="isi" accept=".pdf" required>
                    </div>                    
                    <!-- Tanggal Input -->
                    <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header" style="background-color: #4169E1; color: white;">
                <h5 class="modal-title" id="editModalLabel"><i class="fas fa-edit"></i> Ubah Produk Peraturan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editForm" method="POST" action="edit_produk.php" enctype="multipart/form-data">
    <div class="modal-body">
        <input type="hidden" name="id" id="editId" value="<?php echo $row['id']; ?>">
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="file" class="form-control form-control-lg" id="editIsi" name="isi" accept=".pdf" required>
           
        </div>
        <!-- Tanggal Input -->
        <div class="mb-3">
            <label for="editTanggal" class="form-label">Tanggal</label>
            <input type="date" class="form-control form-control-lg" id="editTanggal" name="tanggal" value="<?php echo $row['tanggal']; ?>" required>
        </div>
...
<script>
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            deleteLink.href = 'hapus_produk.php?id=' + id; // Set the href of the delete link in the modal
        });
    });
</script>
<script>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="produk.php" class="btn btn-primary">OK</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p>File Anda gagal diperbarui, pastikan unggah file dengan format pdf dengan ukuran ≤2MB.</p>
            </div>
            <div class="modal-footer">
                <a href="produk.php" class="btn btn-danger">OK</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="produk.php" class="btn btn-success">OK</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="text-danger">Data gagal ditambahkan!</h4>
                <p>File Anda gagal diunggah, pastikan unggah file dengan format pdf dengan ukuran ≤2MB.</p>
            </div>
            <div class="modal-footer">
                <a href="produk.php" class="btn btn-danger">OK</a>
            </div>
