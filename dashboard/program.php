...
$sqlJawab = "SELECT Id_struktur, jabatan FROM struktur";
$resultJawab = $conn->query($sqlJawab);
?>      
...
<?php
            ...
            $sql = "SELECT program.*, struktur.jabatan AS p_jawab 
            FROM program
            LEFT JOIN struktur ON program.p_jawab = struktur.Id_struktur";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    data-p_jawab='" . htmlspecialchars($row['p_jawab']) . "' 
               ...
               <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#confirmDeleteModal' data-id='" . $row['id_program'] . "'>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="addModalLabel"><i class="fas fa-plus-circle"></i> Tambah Data Program Kerja</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="tambah_program.php" method="POST">
                <div class="modal-body">
                    <!-- Kategori Input -->
                    <div class="mb-3">
                        <select class="form-control form-control-lg" id="p_jawab" name="p_jawab" required>
                            <option value="">Pilih Penanggung Jawab</option>
                            <?php
                            if ($resultJawab->num_rows > 0) {
                                while ($row = $resultJawab->fetch_assoc()) {
                                    $jawabId = htmlspecialchars($row['Id_struktur']);
                                    $jawabNama = htmlspecialchars($row['jabatan']);
                                    echo "<option value='$jawabId'>$jawabNama</option>";
                                }
                            } else {
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg" id="kegiatan" name="kegiatan" placeholder="Masukkan kategori program" required>
                    </div>
                    <!-- Tanggal Input -->
                    <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header" style="background-color: #4169E1; color: white;">
                <h5 class="modal-title" id="editModalLabel"><i class="fas fa-edit"></i> Ubah Program Kerja</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editForm" method="POST" action="edit_program.php">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg" id="editKegiatan" name="kegiatan" placeholder="Masukkan kategori program" required>
                    </div>
                    <!-- Judul Input -->
                    <!-- Tanggal Input -->
                    <div class="mb-3">
...
<script>
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            deleteLink.href = 'hapus_program.php?id=' + id; // Set the href of the delete link in the modal
        });
    });
</script>
    <script>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="program.php" class="btn btn-primary">OK</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="program.php" class="btn btn-success">OK</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade show animate__animated animate__zoomIn" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true" style="display: block;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="program.php" class="btn btn-danger">OK</a>
            </div>
        </div>
    </div>
</div>
